...
RUN cd /app/src && g++ -std=c++26 -O3 -s -DNDEBUG -pthread -I/usr/include/ -I/usr/local/include/ -L/usr/lib/ hash/*.cpp kvs/kvs.cpp primegen/primegen.cpp kvs/kvs_test.cpp -lgtest -lgtest_main -o kvs_test && ./kvs_test
